  ...
  mentor: {
    ...
    dashboard: {
      ...
      availability: {
        ...
        applyToWeekdays: string;
        applyToAllDays: string;
        clearAllSlots: string;
        available: string;
        unavailable: string;
        dragToSelect: string;
        clickInstructions: string;
        mentorshipFormatQuestion: string;
        oneOnOneSessions: string;
        smallGroup: string;
        officeHours: string;
        setAvailability: string;
        defineAvailability: string;
        cancel: string;
        saving: string;
        ...
        applyChangesToWeekdays: string;
        applyToSelected: string;
        applyToWeekdaysHint: string;
        saveChanges: string;
      };
    };
    heroTitle: {
    ...
    applicationForm: {
      ...
      academicBackgroundPlaceholder: string;
      areasOfInterest: string;
      areasOfInterestPlaceholder: string;
      addInterest: string;
      languages: string;
      selectLanguage: string;
      internationalExperience: string;
      hasInternationalExperience: string;
      previous: string;
    ...
    errorLoadingMentors: string;
    noMentorsFound: string;
    noMentorsTitle: string;
    noMentorsMessage: string;
