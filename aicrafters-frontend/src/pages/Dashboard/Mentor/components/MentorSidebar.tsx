...
export const MentorSidebar: React.FC<SidebarProps> = ({ 
  isOpen, 
  isMobileOpen, 
  onToggle, 
  onMobileClose 
  ...
  const menuItems = [
    ...
    { text: 'Mentees', icon: <PeopleIcon />, path: 'mentees' },
    { 
      text: 'Messages', 
      icon: <Badge badgeContent={unreadMessagesCount > 0 ? unreadMessagesCount : undefined} color="error"><MessageIcon /></Badge>, 
      path: 'messages' 
    },
    { 
      text: 'Notifications', 
  ...
  const handleNavigation = (path: string) => {
    const basePath = `/${currentLang}/dashboard/mentor`;
