        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!userCourse.certificateId) {
                    ...
                    // Refresh user data
                    const updatedUser = yield User_1.User.findById(userId).exec();
                    if (updatedUser) {
                ...
                const { pdfBuffer, imageUrl } = yield certificateService_1.certificateService.generateAndUploadCertificate(certificateData, courseId);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!userCourse.certificateImageUrl && userCourse.status === 'completed') {
                    ...
                    const { imageUrl } = yield certificateService_1.certificateService.generateAndUploadCertificate(certificateData, courseId);
