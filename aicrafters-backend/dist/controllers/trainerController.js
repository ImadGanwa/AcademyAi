...
exports.trainerController = {
    ...
    getStats: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const stats = yield (0, trainerService_1.getSystemStats)();
            res.status(200).json({
                success: true,
                data: Object.assign(Object.assign({}, stats), { timestamp: new Date().toISOString(), uptime: process.uptime(), memory: process.memoryUsage() })
            });
        }
        catch (error) {
     ...
     */
    healthCheck: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const stats = yield (0, trainerService_1.getSystemStats)();
     ...
     */
    preloadContent: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield (0, trainerService_1.preloadPopularContent)();
            res.status(200).json({
                success: true,
     ...
     */
    invalidateCache: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { courseId } = req.params;
            const { videoUrl } = req.query;
            yield (0, trainerService_1.invalidateContextCache)(courseId, videoUrl);
            res.status(200).json({
                success: true,
                message: videoUrl
