...
exports.courseController = {
            ...
            if (organizations.length > 0) {
                ...
                for (const org of orgs) {
                    ...
                    for (const course of orgCourses) {
                        // Check if user already has this course
                        const existingCourse = (_b = userDoc.courses) === null || _b === void 0 ? void 0 : _b.find(c => c.courseId._id.toString() === course._id.toString());
                        if (!existingCourse) {
    ...
    markLessonComplete: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            res.json({
                ...
                status: finalCourse === null || finalCourse === void 0 ? void 0 : finalCourse.status,
                certificateId: finalCourse === null || finalCourse === void 0 ? void 0 : finalCourse.certificateId
            });
        }
        catch (error) {
    ...
    checkCourseAccess: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const hasAccess = user.courses.some(course => course.courseId.toString() === courseId && (course.status === 'in progress' || course.status === 'completed'));
