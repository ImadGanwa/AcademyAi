...
exports.getCountryCode = exports.isValidCountry = exports.SUPPORTED_COUNTRIES = exports.getLanguageFlag = exports.getCountryFlagByName = exports.getCountryFlag = exports.getCountryName = exports.LANGUAGE_COUNTRY_MAP = exports.COUNTRY_FLAG_MAP = exports.COUNTRY_CODE_MAP = void 0;
...
const getCountryName = (countryInput) => {
    ...
    if (exports.COUNTRY_CODE_MAP[upperInput]) {
        return exports.COUNTRY_CODE_MAP[upperInput];
    }
    // Check if it's already a full country name (case-insensitive)
    const fullCountryNames = Object.values(exports.COUNTRY_CODE_MAP);
    const matchedCountry = fullCountryNames.find(country => country.toLowerCase() === countryInput.toLowerCase());
    if (matchedCountry) {
...
const getCountryFlag = (countryCode) => {
    ...
    return exports.COUNTRY_FLAG_MAP[upperCode] || null;
};
exports.getCountryFlag = getCountryFlag;
// Get flag URL from country name
const getCountryFlagByName = (countryName) => {
    const countryCode = (0, exports.getCountryCode)(countryName);
    return countryCode ? (0, exports.getCountryFlag)(countryCode) : null;
};
exports.getCountryFlagByName = getCountryFlagByName;
// Get flag URL for a language
const getLanguageFlag = (language) => {
    const countryCode = exports.LANGUAGE_COUNTRY_MAP[language];
    return countryCode ? (0, exports.getCountryFlag)(countryCode) : null;
};
exports.getLanguageFlag = getLanguageFlag;
// List of all supported countries (full names)
exports.SUPPORTED_COUNTRIES = Object.values(exports.COUNTRY_CODE_MAP)
...
const isValidCountry = (country) => {
    ...
    return exports.SUPPORTED_COUNTRIES.some(supportedCountry => supportedCountry.toLowerCase() === country.toLowerCase());
};
...
const getCountryCode = (countryName) => {
    if (!countryName)
        return null;
    const entry = Object.entries(exports.COUNTRY_CODE_MAP).find(([, fullName]) => fullName.toLowerCase() === countryName.toLowerCase());
