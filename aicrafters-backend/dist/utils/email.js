...
exports.sendSessionCompletionEmail = exports.sendBookingUpdateEmail = exports.sendMentorBookingCancelledEmail = exports.sendMenteeBookingCancelledEmail = exports.sendMenteeBookingConfirmedEmail = exports.sendMentorBookingConfirmedEmail = exports.sendMenteeBookingConfirmationEmail = exports.sendMentorBookingNotificationEmail = exports.sendMentorWelcomeEmail = exports.sendMentorRejectionEmail = exports.sendMentorApprovalEmail = exports.sendPasswordResetConfirmationEmail = exports.sendPasswordResetEmail = exports.sendCourseInvitationEmail = exports.sendNewUserNotificationEmail = exports.sendPurchaseConfirmationEmail = exports.sendAccountActivationEmail = exports.sendCourseSubmissionEmail = exports.sendCourseRejectionEmail = exports.sendCourseApprovalEmail = exports.sendWelcomeEmail = exports.sendVerificationEmail = exports.generatePasswordResetToken = exports.generateVerificationToken = void 0;
 ...
 */
const createStyledButton = (text, url, type = 'primary') => {
 ...
 */
const createStyledCard = (contentHtml, backgroundColor = theme.palette.background.paper) => {
    return `
    <div style="
 ...
 */
const createBaseEmailHtml = (headline, contentHtml, preheaderText = '') => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
const generatePasswordResetToken = (email) => {
    ...
    return jsonwebtoken_1.default.sign({ email }, JWT_SECRET, { expiresIn: '1h' });
};
exports.generatePasswordResetToken = generatePasswordResetToken;
// --- Email Sending Functions (Rewritten with new templates) ---
const sendVerificationEmail = (email, fullName, token) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendWelcomeEmail = (email, fullName, password) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendCourseApprovalEmail = (email, fullName, courseTitle, courseId) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendCourseApprovalEmail = sendCourseApprovalEmail;
const sendCourseRejectionEmail = (email, fullName, courseTitle, courseId) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendCourseSubmissionEmail = (email, fullName, courseTitle) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendCourseSubmissionEmail = sendCourseSubmissionEmail;
const sendAccountActivationEmail = (email, fullName) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendPurchaseConfirmationEmail = (email, fullName, courseTitle, courseId, instructorName) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendNewUserNotificationEmail = (adminEmail, adminName, userName, userEmail) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendCourseInvitationEmail = (email, courseTitle, courseId, instructorName) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendCourseInvitationEmail = sendCourseInvitationEmail;
const sendPasswordResetEmail = (email, fullName, token) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendPasswordResetConfirmationEmail = (email, fullName) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendMentorApprovalEmail = (email, fullName) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMentorApprovalEmail = sendMentorApprovalEmail;
const sendMentorRejectionEmail = (email, fullName, reason) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMentorRejectionEmail = sendMentorRejectionEmail;
const sendMentorWelcomeEmail = (email, fullName, password) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMentorWelcomeEmail = sendMentorWelcomeEmail;
...
const createIcsContent = (summary, startDate, endDate, description, location = 'Online') => {
...
const createGoogleCalendarLink = (summary, startDate, endDate, description, location = 'Online') => {
    const formatICSDate = (date) => date.toISOString().replace(/-|:|\.\d+/g, '');
...
const createCalendarSectionHtml = (icsContent, googleLink) => {
    return `
...
const sendMentorBookingNotificationEmail = (mentorEmail, mentorName, menteeName, bookingId, topic, scheduledDate, // YYYY-MM-DD
startTime, // HH:MM (24h)
endTime, // HH:MM (24h)
meetingLink // Optional meeting link
...
exports.sendMentorBookingNotificationEmail = sendMentorBookingNotificationEmail;
const sendMenteeBookingConfirmationEmail = (menteeEmail, menteeName, mentorName, bookingId, topic, scheduledDate, // YYYY-MM-DD
startTime, // HH:MM (24h)
endTime, // HH:MM (24h)
price, meetingLink) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMenteeBookingConfirmationEmail = sendMenteeBookingConfirmationEmail;
const sendMentorBookingConfirmedEmail = (// Note: Renamed from the original to avoid conflict, assuming this is the intended final name for the "mentor" confirmation
mentorEmail, mentorName, menteeName, bookingId, topic, scheduledDate, startTime, endTime, meetingLink) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMentorBookingConfirmedEmail = sendMentorBookingConfirmedEmail;
const sendMenteeBookingConfirmedEmail = (// This is the second version from the user's input
menteeEmail, menteeName, mentorName, bookingId, topic, scheduledDate, startTime, endTime, meetingLink) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMenteeBookingConfirmedEmail = sendMenteeBookingConfirmedEmail;
const sendMenteeBookingCancelledEmail = (menteeEmail, menteeName, mentorName, topic, scheduledDate, // YYYY-MM-DD
startTime, // HH:MM (24h)
endTime, // HH:MM (24h)
cancelledBy, reason) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMenteeBookingCancelledEmail = sendMenteeBookingCancelledEmail;
const sendMentorBookingCancelledEmail = (mentorEmail, mentorName, menteeName, topic, scheduledDate, // YYYY-MM-DD
startTime, // HH:MM (24h)
endTime, // HH:MM (24h)
cancelledBy, reason) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMentorBookingCancelledEmail = sendMentorBookingCancelledEmail;
const sendBookingUpdateEmail = (menteeEmail, menteeName, mentorName, bookingId, topic, scheduledDate, // YYYY-MM-DD
startTime, // HH:MM (24h)
endTime, // HH:MM (24h)
meetingLink, sharedNotes) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendBookingUpdateEmail = sendBookingUpdateEmail;
const sendSessionCompletionEmail = (menteeEmail, menteeName, mentorName, bookingId, topic, scheduledDate, // YYYY-MM-DD
sharedNotes) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendSessionCompletionEmail = sendSessionCompletionEmail;
