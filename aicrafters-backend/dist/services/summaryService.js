    ...
    static getVideoTranscriptionWithSummaries(courseId, videoUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let transcription = yield VideoTranscription_1.VideoTranscription.findOne({
                    courseId,
                    videoUrl: cleanedVideoUrl
                });
                // If not found, try a more flexible search (URL contains the video ID)
                if (!transcription) {
                    const vimeoId = (_a = cleanedVideoUrl.split('/').pop()) === null || _a === void 0 ? void 0 : _a.trim();
                    if (vimeoId) {
                        transcription = (yield VideoTranscription_1.VideoTranscription.findOne({
                            courseId,
