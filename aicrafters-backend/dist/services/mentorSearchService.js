...
exports.searchMentors = searchMentors;
 ...
 */
function calculateRelevanceScore(mentor, params) {
    let score = 0;
 ...
 */
function searchMentors(params) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { skills, languages, countries, availability, query, limit = 10 } = params;
            ...
            // Execute the query
            let mentors = yield MentorApplication_1.MentorApplication.find(filter)
