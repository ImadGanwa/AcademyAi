...
async function simulateChat(userId, courseId, videoUrl, message, threadId) {
...
async function runTests() {
  ...
  let result1 = await simulateChat('user1', 'course1', 'video1', 'Hello in course 1', null);
  console.log(`User message in course 1: Got threadId ${result1.threadId}`);
  
  let result2 = await simulateChat('user1', 'course2', 'video1', 'Hello in course 2', null);
  ...
  let result3 = await simulateChat('user1', 'course1', 'video2', 'New video question', result1.threadId);
  ...
  let result4 = await simulateChat('user2', 'course1', 'video1', 'Another user in course 1', null);
